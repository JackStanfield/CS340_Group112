...
CREATE TABLE Wizards (
    ...
    FOREIGN KEY (masterID) REFERENCES Wizards(wizardID) ON DELETE SET NULL -- Prevents deletion error for apprentices
);
...
CREATE TABLE Chronicles (
    ...
    FOREIGN KEY (wizardID) REFERENCES Wizards(wizardID) ON DELETE SET NULL -- Prevents deletion error for books
);
...
-- (Insert statements remain the same as your previous version)
